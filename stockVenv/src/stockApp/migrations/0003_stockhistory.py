# Generated by Django 4.2.3 on 2023-08-22 16:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stockApp', '0002_alter_category_options_alter_stock_options'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stockApp.category')),
            ],
            options={
